...
function Animation() {
    ...
    useEffect(()=>{
        ...
        [1,2,3,6,8,9,10,14,15,16,24,27.5,28.5,30].map((num:number)=>{
            ...
            <svg width='100%' height='100%'>
                ...
                <defs>
                    ...
                    <pattern id="g1_1" width="100%" height="100%">
                        ...
                        <animate attributeName="x" values="-150;-50" dur="6s" begin='1s' repeatCount="1"/>
                        </image>
                    </pattern>

                    <pattern id="g1_2" width="100%" height="100%">
                        <image href={G1_bg2} y="0" width='330'>
                        <animate attributeName="x" values="0;-50" dur="5s" begin='2s' repeatCount="1"/>
                        </image>
                    </pattern>

                    <pattern id="g1_3" width="100%" height="100%">
                        <image href={G1_bg3} x="0" width="290">
                        <animate attributeName="y" values="0;-50" dur="4s" begin='3s' repeatCount="1"/>
                        </image>
                    </pattern>

                    <pattern id="g2_1" width="100%" height="100%" patternUnits="userSpaceOnUse">
                        <image href={G2_bg1} y="0" height="240px">
                        <animate attributeName="x" values="-100;0" dur="6s" begin='8s' repeatCount="1"/>
                        </image>
                    </pattern>

                    <pattern id="g2_2" width="100%" height="100%" patternUnits="userSpaceOnUse">
                        <image href={G2_bg2} x="0" height="340px">
                        <animate attributeName="y" values="0;-100" dur="6s" begin='8s' repeatCount="1"/>
                        </image>
                    </pattern>

                    <pattern id="g2_3" width="100%" height="100%" patternUnits="userSpaceOnUse">
                        <image href={G2_bg3} y="0" height="240px">
                        <animate attributeName="x" values="200;100" dur="6s" begin='8s' repeatCount="1"/>
                        </image>
                    </pattern>

                    <pattern id="g3_1" width="100%" height="100%">
                        <image opacity='0' href={G3_bg1} y="110" width="450px">
                        <animate attributeName="x" values="0;-50" dur="8s" begin='22s' repeatCount="1"/>
                        <animate attributeName="opacity" values="0;1" dur="1s" fill='freeze' begin='22s' repeatCount="1"/>
                        <animate attributeName="opacity" values="1;0" dur="1s" fill='freeze' begin='29s' repeatCount="1"/>
                        </image>
                    </pattern>
                    ...
                    <linearGradient id="linearG" x1="0%" y1="0%" x2="110%" y2="22%">
                        ...
                        <animate attributeName="offset" dur="1s" values="0;1" fill='freeze' begin='15s' repeatCount="1" />
                        </stop>
                ...
                <G3 anime={animeState}>
                    ...
                    <text className='g3_text3' y='170' opacity='0' dominantBaseline="middle" textAnchor="middle" fill='white' fontFamily='arial' fontSize='65' fontWeight='900' fontStyle='italic'>
                        <animate attributeName='x' values='20%;50%' fill='freeze' calcMode="spline" keySplines='0 .5 .5 1' begin='17s' dur='1.5s' repeatCount="1"/>
                        <animate attributeName='opacity' values='0;1' fill='freeze' begin='17s' dur='3s' repeatCount="1"/>
                        <animate attributeName='opacity' values='1;0' fill='freeze' begin='21.2s' dur='1s' repeatCount="1"/>
                        <animate attributeName='opacity' values='0;1' fill='freeze' begin='29.5s' dur='.5s' repeatCount="1"/>
                        <animate attributeName='opacity' values='1;0' fill='freeze' begin='30s' dur='.5s' repeatCount="1"/>
                        Vancouver
                    </text>
